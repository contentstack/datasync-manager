export const response = {
  'items': [{
    ...
    },
    {
      ...
      'event_at': '2019-01-02T13:42:58.721Z',
      ...
      'data': {
        ...
        'tags': [],
        'filename': 'medium.png',
        'url': 'https://images.contentstack.io/v3/assets/***REMOVED***/blt2a94dd7005d1229c/5c0e49ea4556bd510d0e1d5e/medium.png',
        'is_dir': false,
        '_version': 1,
        'title': 'medium.png',
        'publish_details': {
  ...
  'limit': 100,
  'total_count': 2,
  'sync_token': 'blt3e55360a07310a157082b8',
}
