...
export const MESSAGES = {
  ...
  SYNC_CORE: {
    ...
    ERROR_MAP: 'Content type schema fetch failed.',
    ERROR_MAP_RESOLVE: 'Mapping resolution failed.',
    ERROR_FILTER_ITEMS: 'Item filtering failed.',
    ERROR_FIRE: 'Fire operation encountered error.',
